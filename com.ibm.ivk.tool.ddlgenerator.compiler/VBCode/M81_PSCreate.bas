...
Private Sub genPsCreateSupportDdlByPool( _
  ...
  With g_classes.descriptors(g_classIndexAggregationSlot)
    attrNameFkAggSlot = genSurrogateKeyName(ddlType, .shortName)
  End With
  ...
  With g_classes.descriptors(g_classIndexCategory)
    categoryShortName = .shortName
    categoryClassIdStr = .classIdStr
  End With
  ...
  For i = 1 To 2
    ...
    With g_classes.descriptors(g_classIndexProductStructure)
      setAttributeMapping transformation, 2, genSurrogateKeyName(ddlType, .shortName), "v_psOidNew"
    End With
    ...
    setAttributeMapping transformation, 3, conStatusId, CStr(statusWorkInProgress), , , True
    setAttributeMapping transformation, 4, conLrtState, CStr(lrtStatusCreated)
    With g_classes.descriptors(g_classIndexEndSlot)
      setAttributeMapping transformation, 5, genSurrogateKeyName(ddlType, .shortName), "v_tempEndSlotGenOid"
    End With
    setAttributeMapping transformation, 6, conLanguageId, "languageId1_in"
    setAttributeMapping transformation, 7, conChangeComment, "lrtComment_in"
    setAttributeMapping transformation, 8, conVersionId, "1"
    ...
    With g_classes.descriptors(g_classIndexEndSlot)
      setAttributeMapping transformation, 5, genSurrogateKeyName(ddlType, .shortName), "v_dupEndSlotGenOid"
    End With
    setAttributeMapping transformation, 6, conLanguageId, "languageId1_in"
    setAttributeMapping transformation, 7, conChangeComment, "lrtComment_in"
    ...
    setAttributeMapping transformation, 5, conVersionId, "1"
    With g_classes.descriptors(g_classIndexEndSlot)
      setAttributeMapping transformation, 6, genSurrogateKeyName(ddlType, .shortName), "v_tempEndSlotOid"
    End With
    ...
    With g_classes.descriptors(g_classIndexEndSlot)
      setAttributeMapping transformation, 6, genSurrogateKeyName(ddlType, .shortName), "v_dupEndSlotOid"
    End With
