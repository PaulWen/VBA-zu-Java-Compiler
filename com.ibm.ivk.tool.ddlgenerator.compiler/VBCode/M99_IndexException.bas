...
Private Sub readSheet()
  ...
  While thisSheet.Cells(thisRow, colSection) & "" <> ""
    ...
    With g_indexExcp.descriptors(g_indexExcp.numDescriptors)
      .sectionName = Trim(thisSheet.Cells(thisRow, colSection))
      .sectionShortName = Trim(thisSheet.Cells(thisRow, colSectionShortName))
      .indexName = Trim(thisSheet.Cells(thisRow, colIndexName))
      .noIndexInPool = Trim(thisSheet.Cells(thisRow, colNoIndexInPool))
    End With
