...
public final class AArithmeticExpressionInParensComparisonValue extends PComparisonValue
{
    private TOpenParen _openParen_;
    private PArithmeticExpression _arithmeticExpression_;
    private TCloseParen _closeParen_;

    public AArithmeticExpressionInParensComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArithmeticExpressionInParensComparisonValue(
    ...
    {
        ((Analysis) sw).caseAArithmeticExpressionInParensComparisonValue(this);
    }
