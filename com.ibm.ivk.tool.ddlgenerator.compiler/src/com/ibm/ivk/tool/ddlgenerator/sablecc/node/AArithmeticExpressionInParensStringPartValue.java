...
public final class AArithmeticExpressionInParensStringPartValue extends PStringPartValue
{
    private TOpenParen _openParen_;
    private PArithmeticExpression _arithmeticExpression_;
    private TCloseParen _closeParen_;

    public AArithmeticExpressionInParensStringPartValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArithmeticExpressionInParensStringPartValue(
    ...
    {
        ((Analysis) sw).caseAArithmeticExpressionInParensStringPartValue(this);
    }
