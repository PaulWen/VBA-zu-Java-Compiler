...
public final class AArithmeticExpressionParamCallListWithoutParensValue extends PParamCallListWithoutParensValue
{
    private PArithmeticExpression _arithmeticExpression_;

    public AArithmeticExpressionParamCallListWithoutParensValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArithmeticExpressionParamCallListWithoutParensValue(
            cloneNode(this._arithmeticExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAArithmeticExpressionParamCallListWithoutParensValue(this);
    }
