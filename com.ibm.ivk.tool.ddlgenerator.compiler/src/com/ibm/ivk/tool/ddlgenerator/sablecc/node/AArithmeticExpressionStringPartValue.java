...
public final class AArithmeticExpressionStringPartValue extends PStringPartValue
{
    private PArithmeticExpression _arithmeticExpression_;

    public AArithmeticExpressionStringPartValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArithmeticExpressionStringPartValue(
            cloneNode(this._arithmeticExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAArithmeticExpressionStringPartValue(this);
    }
