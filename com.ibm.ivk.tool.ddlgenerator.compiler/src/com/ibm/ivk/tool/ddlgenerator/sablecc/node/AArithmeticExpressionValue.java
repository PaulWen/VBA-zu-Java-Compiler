...
public final class AArithmeticExpressionValue extends PValue
{
    private PArithmeticExpression _arithmeticExpression_;

    public AArithmeticExpressionValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArithmeticExpressionValue(
            cloneNode(this._arithmeticExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAArithmeticExpressionValue(this);
    }
