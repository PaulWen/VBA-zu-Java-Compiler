...
public final class AArrayResizePreserveData extends PArrayResizePreserveData
{
    private TArrayResizeToken _arrayResizeToken_;
    private TPreserve _preserve_;
    ...
    public AArrayResizePreserveData()
    {
        // Constructor
    }
    ...
    public AArrayResizePreserveData(
        ...
        @SuppressWarnings("hiding") TPreserve _preserve_,
    ...
    public Object clone()
    {
        return new AArrayResizePreserveData(
            cloneNode(this._arrayResizeToken_),
            cloneNode(this._preserve_),
    ...
    {
        ((Analysis) sw).caseAArrayResizePreserveData(this);
    }
    ...
    public TPreserve getPreserve()
    {
        return this._preserve_;
    }

    public void setPreserve(TPreserve node)
    {
        if(this._preserve_ != null)
        {
            this._preserve_.parent(null);
        }
    ...
    void removeChild(@SuppressWarnings("unused") Node child)
    {
        ...
        if(this._preserve_ == child)
        {
            this._preserve_ = null;
            return;
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._preserve_ == oldChild)
        {
            setPreserve((TPreserve) newChild);
            return;
        }
