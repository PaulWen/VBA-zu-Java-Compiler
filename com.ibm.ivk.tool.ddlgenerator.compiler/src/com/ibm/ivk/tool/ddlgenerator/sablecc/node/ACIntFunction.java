...
public final class ACIntFunction extends PCIntFunction
{
    private TCInt _cInt_;
    private TOpenParen _openParen_;
    private PValue _value_;
    private TCloseParen _closeParen_;

    public ACIntFunction()
    {
        // Constructor
    }

    public ACIntFunction(
        @SuppressWarnings("hiding") TCInt _cInt_,
    ...
    public Object clone()
    {
        return new ACIntFunction(
            cloneNode(this._cInt_),
    ...
    {
        ((Analysis) sw).caseACIntFunction(this);
    }

    public TCInt getCInt()
    {
        return this._cInt_;
    }

    public void setCInt(TCInt node)
    {
        if(this._cInt_ != null)
        {
            this._cInt_.parent(null);
        }
    ...
    {
        // Replace child
        if(this._cInt_ == oldChild)
        {
            setCInt((TCInt) newChild);
            return;
        }
