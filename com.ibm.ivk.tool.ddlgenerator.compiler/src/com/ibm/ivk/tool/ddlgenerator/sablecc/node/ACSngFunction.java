...
public final class ACSngFunction extends PCSngFunction
{
    private TCSng _cSng_;
    private TOpenParen _openParen_;
    private PStringValue _stringValue_;
    private TCloseParen _closeParen_;

    public ACSngFunction()
    {
        // Constructor
    }

    public ACSngFunction(
        @SuppressWarnings("hiding") TCSng _cSng_,
    ...
    public Object clone()
    {
        return new ACSngFunction(
            cloneNode(this._cSng_),
    ...
    {
        ((Analysis) sw).caseACSngFunction(this);
    }

    public TCSng getCSng()
    {
        return this._cSng_;
    }

    public void setCSng(TCSng node)
    {
        if(this._cSng_ != null)
        {
            this._cSng_.parent(null);
        }
    ...
    {
        // Replace child
        if(this._cSng_ == oldChild)
        {
            setCSng((TCSng) newChild);
            return;
        }
