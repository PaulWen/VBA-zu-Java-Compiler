...
public final class ACStrFunctionMoreParamCallValues extends PMoreParamCallValues
{
    private PCStrFunction _cStrFunction_;

    public ACStrFunctionMoreParamCallValues()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACStrFunctionMoreParamCallValues(
            cloneNode(this._cStrFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseACStrFunctionMoreParamCallValues(this);
    }
