...
public final class ACStrFunctionParamCallListWithoutParensValue extends PParamCallListWithoutParensValue
{
    private PCStrFunction _cStrFunction_;

    public ACStrFunctionParamCallListWithoutParensValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACStrFunctionParamCallListWithoutParensValue(
            cloneNode(this._cStrFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseACStrFunctionParamCallListWithoutParensValue(this);
    }
