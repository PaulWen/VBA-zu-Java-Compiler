...
public final class ACStrFunctionStringPartValue extends PStringPartValue
{
    private PCStrFunction _cStrFunction_;

    public ACStrFunctionStringPartValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACStrFunctionStringPartValue(
            cloneNode(this._cStrFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseACStrFunctionStringPartValue(this);
    }
