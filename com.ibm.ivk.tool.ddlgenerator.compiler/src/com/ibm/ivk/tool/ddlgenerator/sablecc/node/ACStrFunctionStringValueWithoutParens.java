...
public final class ACStrFunctionStringValueWithoutParens extends PStringValueWithoutParens
{
    private PCStrFunction _cStrFunction_;

    public ACStrFunctionStringValueWithoutParens()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACStrFunctionStringValueWithoutParens(
            cloneNode(this._cStrFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseACStrFunctionStringValueWithoutParens(this);
    }
