...
public final class ACharacterStringInParanesComparisonValue extends PComparisonValue
{
    private TOpenParen _openParen_;
    private PCharacterString _characterString_;
    private TCloseParen _closeParen_;

    public ACharacterStringInParanesComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACharacterStringInParanesComparisonValue(
    ...
    {
        ((Analysis) sw).caseACharacterStringInParanesComparisonValue(this);
    }
