...
public final class ACharacterStringMoreParamCallValues extends PMoreParamCallValues
{
    private PCharacterString _characterString_;

    public ACharacterStringMoreParamCallValues()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACharacterStringMoreParamCallValues(
            cloneNode(this._characterString_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseACharacterStringMoreParamCallValues(this);
    }
