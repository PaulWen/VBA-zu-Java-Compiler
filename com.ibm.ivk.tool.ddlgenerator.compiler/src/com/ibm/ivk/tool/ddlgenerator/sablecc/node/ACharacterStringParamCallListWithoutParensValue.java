...
public final class ACharacterStringParamCallListWithoutParensValue extends PParamCallListWithoutParensValue
{
    private PCharacterString _characterString_;

    public ACharacterStringParamCallListWithoutParensValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACharacterStringParamCallListWithoutParensValue(
            cloneNode(this._characterString_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseACharacterStringParamCallListWithoutParensValue(this);
    }
