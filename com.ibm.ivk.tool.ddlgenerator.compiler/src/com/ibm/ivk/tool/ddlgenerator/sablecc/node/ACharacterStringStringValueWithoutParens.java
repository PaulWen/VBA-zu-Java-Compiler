...
public final class ACharacterStringStringValueWithoutParens extends PStringValueWithoutParens
{
    private PCharacterString _characterString_;

    public ACharacterStringStringValueWithoutParens()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACharacterStringStringValueWithoutParens(
            cloneNode(this._characterString_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseACharacterStringStringValueWithoutParens(this);
    }
