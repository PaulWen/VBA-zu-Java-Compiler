...
public final class AComparisonLogicalValue extends PLogicalValue
{
    private PComparison _comparison_;

    public AComparisonLogicalValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComparisonLogicalValue(
            cloneNode(this._comparison_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAComparisonLogicalValue(this);
    }
