...
public final class AConditionInParensCondition extends PCondition
{
    private PConditionInParens _conditionInParens_;

    public AConditionInParensCondition()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConditionInParensCondition(
            cloneNode(this._conditionInParens_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAConditionInParensCondition(this);
    }
