...
public final class AConditionInParensLogicalValue extends PLogicalValue
{
    private PConditionInParens _conditionInParens_;

    public AConditionInParensLogicalValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConditionInParensLogicalValue(
            cloneNode(this._conditionInParens_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAConditionInParensLogicalValue(this);
    }
