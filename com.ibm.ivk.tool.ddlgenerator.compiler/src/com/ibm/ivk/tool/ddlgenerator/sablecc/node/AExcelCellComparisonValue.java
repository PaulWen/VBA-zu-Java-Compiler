...
public final class AExcelCellComparisonValue extends PComparisonValue
{
    private PExcelCell _excelCell_;

    public AExcelCellComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExcelCellComparisonValue(
            cloneNode(this._excelCell_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAExcelCellComparisonValue(this);
    }
