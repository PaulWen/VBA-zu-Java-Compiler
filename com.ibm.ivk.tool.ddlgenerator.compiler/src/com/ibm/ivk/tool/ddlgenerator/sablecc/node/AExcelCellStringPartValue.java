...
public final class AExcelCellStringPartValue extends PStringPartValue
{
    private PExcelCell _excelCell_;

    public AExcelCellStringPartValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExcelCellStringPartValue(
            cloneNode(this._excelCell_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAExcelCellStringPartValue(this);
    }
