...
public final class AExcelCellStringValueWithoutParens extends PStringValueWithoutParens
{
    private PExcelCell _excelCell_;

    public AExcelCellStringValueWithoutParens()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExcelCellStringValueWithoutParens(
            cloneNode(this._excelCell_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAExcelCellStringValueWithoutParens(this);
    }
