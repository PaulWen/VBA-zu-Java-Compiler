...
public final class AFalseComparisonValue extends PComparisonValue
{
    private PBooleanValueFalse _booleanValueFalse_;

    public AFalseComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFalseComparisonValue(
            cloneNode(this._booleanValueFalse_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFalseComparisonValue(this);
    }
