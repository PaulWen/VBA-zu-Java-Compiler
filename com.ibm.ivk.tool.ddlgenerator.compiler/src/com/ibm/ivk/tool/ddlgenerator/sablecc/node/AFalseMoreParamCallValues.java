...
public final class AFalseMoreParamCallValues extends PMoreParamCallValues
{
    private PBooleanValueFalse _booleanValueFalse_;

    public AFalseMoreParamCallValues()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFalseMoreParamCallValues(
            cloneNode(this._booleanValueFalse_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFalseMoreParamCallValues(this);
    }
