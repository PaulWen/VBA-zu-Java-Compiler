...
public final class AFalseParamCallListWithoutParensValue extends PParamCallListWithoutParensValue
{
    private PBooleanValueFalse _booleanValueFalse_;

    public AFalseParamCallListWithoutParensValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFalseParamCallListWithoutParensValue(
            cloneNode(this._booleanValueFalse_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFalseParamCallListWithoutParensValue(this);
    }
