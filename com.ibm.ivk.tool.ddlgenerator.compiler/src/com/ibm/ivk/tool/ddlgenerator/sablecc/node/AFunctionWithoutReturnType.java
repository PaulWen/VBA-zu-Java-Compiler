...
public final class AFunctionWithoutReturnType extends PFunctionWithoutReturnType
{
    ...
    public AFunctionWithoutReturnType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFunctionWithoutReturnType(
    ...
    {
        ((Analysis) sw).caseAFunctionWithoutReturnType(this);
    }
