...
public final class AGeneralStmtEnumValue extends PEnumValue
{
    private PGeneralStmt _generalStmt_;

    public AGeneralStmtEnumValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGeneralStmtEnumValue(
            cloneNode(this._generalStmt_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAGeneralStmtEnumValue(this);
    }
