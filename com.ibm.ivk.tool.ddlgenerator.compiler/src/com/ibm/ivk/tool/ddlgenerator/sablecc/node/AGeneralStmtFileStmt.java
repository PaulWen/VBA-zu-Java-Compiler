...
public final class AGeneralStmtFileStmt extends PFileStmt
{
    private PGeneralStmt _generalStmt_;

    public AGeneralStmtFileStmt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGeneralStmtFileStmt(
            cloneNode(this._generalStmt_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAGeneralStmtFileStmt(this);
    }
