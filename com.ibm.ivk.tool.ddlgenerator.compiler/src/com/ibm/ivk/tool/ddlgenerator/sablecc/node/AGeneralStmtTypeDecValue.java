...
public final class AGeneralStmtTypeDecValue extends PTypeDecValue
{
    private PGeneralStmt _generalStmt_;

    public AGeneralStmtTypeDecValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGeneralStmtTypeDecValue(
            cloneNode(this._generalStmt_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAGeneralStmtTypeDecValue(this);
    }
