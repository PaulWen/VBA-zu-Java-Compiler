...
public final class AGetNameExcelFunctionMoreParamCallValues extends PMoreParamCallValues
{
    private PGetNameExcelFunction _getNameExcelFunction_;

    public AGetNameExcelFunctionMoreParamCallValues()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGetNameExcelFunctionMoreParamCallValues(
            cloneNode(this._getNameExcelFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAGetNameExcelFunctionMoreParamCallValues(this);
    }
