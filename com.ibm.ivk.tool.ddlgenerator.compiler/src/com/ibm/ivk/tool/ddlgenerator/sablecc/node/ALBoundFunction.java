...
public final class ALBoundFunction extends PLBoundFunction
{
    private TLBound _lBound_;
    private TOpenParen _openParen_;
    private PValue _value_;
    private TCloseParen _closeParen_;

    public ALBoundFunction()
    {
        // Constructor
    }

    public ALBoundFunction(
        @SuppressWarnings("hiding") TLBound _lBound_,
    ...
    public Object clone()
    {
        return new ALBoundFunction(
            cloneNode(this._lBound_),
    ...
    {
        ((Analysis) sw).caseALBoundFunction(this);
    }

    public TLBound getLBound()
    {
        return this._lBound_;
    }

    public void setLBound(TLBound node)
    {
        if(this._lBound_ != null)
        {
            this._lBound_.parent(null);
        }
    ...
    {
        // Replace child
        if(this._lBound_ == oldChild)
        {
            setLBound((TLBound) newChild);
            return;
        }
