...
public final class ALBoundFunctionValue extends PValue
{
    private PLBoundFunction _lBoundFunction_;

    public ALBoundFunctionValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALBoundFunctionValue(
            cloneNode(this._lBoundFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALBoundFunctionValue(this);
    }
