...
public final class ALCaseFunctionComparisonValue extends PComparisonValue
{
    private PLCaseFunction _lCaseFunction_;

    public ALCaseFunctionComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALCaseFunctionComparisonValue(
            cloneNode(this._lCaseFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALCaseFunctionComparisonValue(this);
    }
