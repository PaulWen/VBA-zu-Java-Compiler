...
public final class ALCaseFunctionStringPartValue extends PStringPartValue
{
    private PLCaseFunction _lCaseFunction_;

    public ALCaseFunctionStringPartValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALCaseFunctionStringPartValue(
            cloneNode(this._lCaseFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALCaseFunctionStringPartValue(this);
    }
