...
public final class ALTrimFunction extends PLTrimFunction
{
    private TLTrim _lTrim_;
    private TOpenParen _openParen_;
    private PStringValue _stringValue_;
    private TCloseParen _closeParen_;

    public ALTrimFunction()
    {
        // Constructor
    }

    public ALTrimFunction(
        @SuppressWarnings("hiding") TLTrim _lTrim_,
    ...
    public Object clone()
    {
        return new ALTrimFunction(
            cloneNode(this._lTrim_),
    ...
    {
        ((Analysis) sw).caseALTrimFunction(this);
    }

    public TLTrim getLTrim()
    {
        return this._lTrim_;
    }

    public void setLTrim(TLTrim node)
    {
        if(this._lTrim_ != null)
        {
            this._lTrim_.parent(null);
        }
    ...
    {
        // Replace child
        if(this._lTrim_ == oldChild)
        {
            setLTrim((TLTrim) newChild);
            return;
        }
