...
public final class ALeftFunctionComparisonValue extends PComparisonValue
{
    private PLeftFunction _leftFunction_;

    public ALeftFunctionComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALeftFunctionComparisonValue(
            cloneNode(this._leftFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALeftFunctionComparisonValue(this);
    }
