...
public final class ALeftFunctionMoreParamCallValues extends PMoreParamCallValues
{
    private PLeftFunction _leftFunction_;

    public ALeftFunctionMoreParamCallValues()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALeftFunctionMoreParamCallValues(
            cloneNode(this._leftFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALeftFunctionMoreParamCallValues(this);
    }
