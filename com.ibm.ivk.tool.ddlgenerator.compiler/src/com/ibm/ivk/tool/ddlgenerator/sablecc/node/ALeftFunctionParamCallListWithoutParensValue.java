...
public final class ALeftFunctionParamCallListWithoutParensValue extends PParamCallListWithoutParensValue
{
    private PLeftFunction _leftFunction_;

    public ALeftFunctionParamCallListWithoutParensValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALeftFunctionParamCallListWithoutParensValue(
            cloneNode(this._leftFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALeftFunctionParamCallListWithoutParensValue(this);
    }
