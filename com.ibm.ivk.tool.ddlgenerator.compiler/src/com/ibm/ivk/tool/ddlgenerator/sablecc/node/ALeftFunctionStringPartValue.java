...
public final class ALeftFunctionStringPartValue extends PStringPartValue
{
    private PLeftFunction _leftFunction_;

    public ALeftFunctionStringPartValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALeftFunctionStringPartValue(
            cloneNode(this._leftFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALeftFunctionStringPartValue(this);
    }
