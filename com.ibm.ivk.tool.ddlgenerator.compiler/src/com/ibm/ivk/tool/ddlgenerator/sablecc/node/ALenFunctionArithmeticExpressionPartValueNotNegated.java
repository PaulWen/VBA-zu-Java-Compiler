...
public final class ALenFunctionArithmeticExpressionPartValueNotNegated extends PArithmeticExpressionPartValueNotNegated
{
    private PLenFunction _lenFunction_;

    public ALenFunctionArithmeticExpressionPartValueNotNegated()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALenFunctionArithmeticExpressionPartValueNotNegated(
            cloneNode(this._lenFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALenFunctionArithmeticExpressionPartValueNotNegated(this);
    }
