...
public final class ALenFunctionComparisonValue extends PComparisonValue
{
    private PLenFunction _lenFunction_;

    public ALenFunctionComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALenFunctionComparisonValue(
            cloneNode(this._lenFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALenFunctionComparisonValue(this);
    }
