...
public final class ALenFunctionIntValue extends PIntValue
{
    private PLenFunction _lenFunction_;

    public ALenFunctionIntValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALenFunctionIntValue(
            cloneNode(this._lenFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALenFunctionIntValue(this);
    }
