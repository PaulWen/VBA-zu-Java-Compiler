...
public final class ALessThanLogicalOperator extends PLogicalOperator
{
    private TLessThan _lessThan_;

    public ALessThanLogicalOperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALessThanLogicalOperator(
            cloneNode(this._lessThan_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALessThanLogicalOperator(this);
    }
