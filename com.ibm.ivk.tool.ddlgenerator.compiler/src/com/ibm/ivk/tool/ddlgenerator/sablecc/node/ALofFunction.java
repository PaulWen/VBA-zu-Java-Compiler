...
public final class ALofFunction extends PLofFunction
{
    private TLof _lof_;
    ...
    public ALofFunction(
        @SuppressWarnings("hiding") TLof _lof_,
    ...
    public Object clone()
    {
        return new ALofFunction(
            cloneNode(this._lof_),
    ...
    {
        ((Analysis) sw).caseALofFunction(this);
    }
    ...
    public void setLof(TLof node)
    {
        if(this._lof_ != null)
        {
            this._lof_.parent(null);
        }
    ...
    {
        // Replace child
        if(this._lof_ == oldChild)
        {
            setLof((TLof) newChild);
            return;
        }
