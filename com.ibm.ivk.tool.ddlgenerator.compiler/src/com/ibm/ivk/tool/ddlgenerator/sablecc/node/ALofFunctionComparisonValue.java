...
public final class ALofFunctionComparisonValue extends PComparisonValue
{
    private PLofFunction _lofFunction_;

    public ALofFunctionComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALofFunctionComparisonValue(
            cloneNode(this._lofFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALofFunctionComparisonValue(this);
    }
