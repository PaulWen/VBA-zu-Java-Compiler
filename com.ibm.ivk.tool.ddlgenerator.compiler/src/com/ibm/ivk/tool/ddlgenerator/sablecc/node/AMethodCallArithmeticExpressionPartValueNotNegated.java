...
public final class AMethodCallArithmeticExpressionPartValueNotNegated extends PArithmeticExpressionPartValueNotNegated
{
    private PMethodCall _methodCall_;

    public AMethodCallArithmeticExpressionPartValueNotNegated()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodCallArithmeticExpressionPartValueNotNegated(
            cloneNode(this._methodCall_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMethodCallArithmeticExpressionPartValueNotNegated(this);
    }
