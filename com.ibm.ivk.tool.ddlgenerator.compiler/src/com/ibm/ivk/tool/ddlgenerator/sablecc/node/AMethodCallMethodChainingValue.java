...
public final class AMethodCallMethodChainingValue extends PMethodChainingValue
{
    private PMethodCall _methodCall_;

    public AMethodCallMethodChainingValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodCallMethodChainingValue(
            cloneNode(this._methodCall_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMethodCallMethodChainingValue(this);
    }
