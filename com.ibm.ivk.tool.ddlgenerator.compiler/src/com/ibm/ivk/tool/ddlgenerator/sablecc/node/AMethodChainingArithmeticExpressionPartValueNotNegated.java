...
public final class AMethodChainingArithmeticExpressionPartValueNotNegated extends PArithmeticExpressionPartValueNotNegated
{
    private PMethodChaining _methodChaining_;

    public AMethodChainingArithmeticExpressionPartValueNotNegated()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodChainingArithmeticExpressionPartValueNotNegated(
            cloneNode(this._methodChaining_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMethodChainingArithmeticExpressionPartValueNotNegated(this);
    }
