...
public final class AMethodChainingBooleanValue extends PBooleanValue
{
    private PMethodChaining _methodChaining_;

    public AMethodChainingBooleanValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodChainingBooleanValue(
            cloneNode(this._methodChaining_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMethodChainingBooleanValue(this);
    }
