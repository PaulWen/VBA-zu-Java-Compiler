...
public final class AMethodChainingComparisonValue extends PComparisonValue
{
    private PMethodChaining _methodChaining_;

    public AMethodChainingComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodChainingComparisonValue(
            cloneNode(this._methodChaining_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMethodChainingComparisonValue(this);
    }
