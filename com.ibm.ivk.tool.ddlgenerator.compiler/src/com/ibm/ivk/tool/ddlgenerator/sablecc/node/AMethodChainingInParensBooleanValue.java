...
public final class AMethodChainingInParensBooleanValue extends PBooleanValue
{
    private TOpenParen _openParen_;
    private PMethodChaining _methodChaining_;
    private TCloseParen _closeParen_;

    public AMethodChainingInParensBooleanValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodChainingInParensBooleanValue(
    ...
    {
        ((Analysis) sw).caseAMethodChainingInParensBooleanValue(this);
    }
