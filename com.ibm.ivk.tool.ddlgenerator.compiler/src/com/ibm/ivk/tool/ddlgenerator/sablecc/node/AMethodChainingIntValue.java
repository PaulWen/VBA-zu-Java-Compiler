...
public final class AMethodChainingIntValue extends PIntValue
{
    private PMethodChaining _methodChaining_;

    public AMethodChainingIntValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodChainingIntValue(
            cloneNode(this._methodChaining_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMethodChainingIntValue(this);
    }
