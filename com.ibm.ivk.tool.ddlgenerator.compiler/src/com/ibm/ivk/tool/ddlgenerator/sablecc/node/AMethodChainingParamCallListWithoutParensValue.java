...
public final class AMethodChainingParamCallListWithoutParensValue extends PParamCallListWithoutParensValue
{
    private PMethodChaining _methodChaining_;

    public AMethodChainingParamCallListWithoutParensValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodChainingParamCallListWithoutParensValue(
            cloneNode(this._methodChaining_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMethodChainingParamCallListWithoutParensValue(this);
    }
