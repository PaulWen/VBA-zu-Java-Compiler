...
public final class AMethodChainingStringPartValue extends PStringPartValue
{
    private PMethodChaining _methodChaining_;

    public AMethodChainingStringPartValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodChainingStringPartValue(
            cloneNode(this._methodChaining_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMethodChainingStringPartValue(this);
    }
