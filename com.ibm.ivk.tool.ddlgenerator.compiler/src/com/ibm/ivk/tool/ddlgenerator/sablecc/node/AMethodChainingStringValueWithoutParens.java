...
public final class AMethodChainingStringValueWithoutParens extends PStringValueWithoutParens
{
    private PMethodChaining _methodChaining_;

    public AMethodChainingStringValueWithoutParens()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodChainingStringValueWithoutParens(
            cloneNode(this._methodChaining_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMethodChainingStringValueWithoutParens(this);
    }
