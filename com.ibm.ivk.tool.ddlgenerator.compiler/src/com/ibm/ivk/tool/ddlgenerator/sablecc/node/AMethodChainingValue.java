...
public final class AMethodChainingValue extends PValue
{
    private PMethodChaining _methodChaining_;

    public AMethodChainingValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodChainingValue(
            cloneNode(this._methodChaining_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMethodChainingValue(this);
    }
