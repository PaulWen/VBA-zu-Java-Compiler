...
public final class AMethodMoreParamCallValues extends PMoreParamCallValues
{
    private PMethodCall _methodCall_;

    public AMethodMoreParamCallValues()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodMoreParamCallValues(
            cloneNode(this._methodCall_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMethodMoreParamCallValues(this);
    }
