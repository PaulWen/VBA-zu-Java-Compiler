...
public final class AMethodStringValueWithoutParens extends PStringValueWithoutParens
{
    private PMethodCall _methodCall_;

    public AMethodStringValueWithoutParens()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodStringValueWithoutParens(
            cloneNode(this._methodCall_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMethodStringValueWithoutParens(this);
    }
