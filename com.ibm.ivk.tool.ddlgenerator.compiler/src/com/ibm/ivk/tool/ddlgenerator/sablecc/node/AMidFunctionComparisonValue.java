...
public final class AMidFunctionComparisonValue extends PComparisonValue
{
    private PMidFunction _midFunction_;

    public AMidFunctionComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMidFunctionComparisonValue(
            cloneNode(this._midFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMidFunctionComparisonValue(this);
    }
