...
public final class AMidFunctionTwoParamComparisonValue extends PComparisonValue
{
    private PMidFunctionTwoParam _midFunctionTwoParam_;

    public AMidFunctionTwoParamComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMidFunctionTwoParamComparisonValue(
            cloneNode(this._midFunctionTwoParam_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMidFunctionTwoParamComparisonValue(this);
    }
