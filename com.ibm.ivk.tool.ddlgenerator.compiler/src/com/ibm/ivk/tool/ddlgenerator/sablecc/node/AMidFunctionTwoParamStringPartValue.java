...
public final class AMidFunctionTwoParamStringPartValue extends PStringPartValue
{
    private PMidFunctionTwoParam _midFunctionTwoParam_;

    public AMidFunctionTwoParamStringPartValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMidFunctionTwoParamStringPartValue(
            cloneNode(this._midFunctionTwoParam_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMidFunctionTwoParamStringPartValue(this);
    }
