...
public final class ANoParamMethodCallWithoutParens extends PMethodCallWithoutParens
{
    private PMethodChaining _methodChaining_;

    public ANoParamMethodCallWithoutParens()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANoParamMethodCallWithoutParens(
            cloneNode(this._methodChaining_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseANoParamMethodCallWithoutParens(this);
    }
