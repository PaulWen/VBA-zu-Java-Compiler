...
public final class AOnlyValueCharacterString extends PCharacterString
{
    private TStringToken _stringToken_;

    public AOnlyValueCharacterString()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOnlyValueCharacterString(
            cloneNode(this._stringToken_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAOnlyValueCharacterString(this);
    }
