...
public final class AParamWithParamName extends PParamWithParamName
{
    private TGotoId _gotoId_;
    private TAllocation _allocation_;
    private PValue _value_;

    public AParamWithParamName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParamWithParamName(
    ...
    {
        ((Analysis) sw).caseAParamWithParamName(this);
    }
