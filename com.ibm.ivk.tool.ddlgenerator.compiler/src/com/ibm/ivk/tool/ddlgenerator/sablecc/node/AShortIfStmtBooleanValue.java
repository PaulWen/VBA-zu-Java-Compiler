...
public final class AShortIfStmtBooleanValue extends PBooleanValue
{
    private PShortIfStmt _shortIfStmt_;

    public AShortIfStmtBooleanValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShortIfStmtBooleanValue(
            cloneNode(this._shortIfStmt_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAShortIfStmtBooleanValue(this);
    }
