...
public final class AShortIfStmtComparisonValue extends PComparisonValue
{
    private PShortIfStmt _shortIfStmt_;

    public AShortIfStmtComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShortIfStmtComparisonValue(
            cloneNode(this._shortIfStmt_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAShortIfStmtComparisonValue(this);
    }
