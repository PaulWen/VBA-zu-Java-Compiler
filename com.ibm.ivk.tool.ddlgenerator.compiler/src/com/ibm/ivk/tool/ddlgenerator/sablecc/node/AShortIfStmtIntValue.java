...
public final class AShortIfStmtIntValue extends PIntValue
{
    private PShortIfStmt _shortIfStmt_;

    public AShortIfStmtIntValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShortIfStmtIntValue(
            cloneNode(this._shortIfStmt_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAShortIfStmtIntValue(this);
    }
