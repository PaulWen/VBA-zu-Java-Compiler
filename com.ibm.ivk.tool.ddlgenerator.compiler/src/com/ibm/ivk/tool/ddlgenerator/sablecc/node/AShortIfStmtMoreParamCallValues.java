...
public final class AShortIfStmtMoreParamCallValues extends PMoreParamCallValues
{
    private PShortIfStmt _shortIfStmt_;

    public AShortIfStmtMoreParamCallValues()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShortIfStmtMoreParamCallValues(
            cloneNode(this._shortIfStmt_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAShortIfStmtMoreParamCallValues(this);
    }
