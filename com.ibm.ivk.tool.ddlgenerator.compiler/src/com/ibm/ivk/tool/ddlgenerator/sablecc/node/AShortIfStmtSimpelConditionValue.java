...
public final class AShortIfStmtSimpelConditionValue extends PSimpelConditionValue
{
    private PShortIfStmt _shortIfStmt_;

    public AShortIfStmtSimpelConditionValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShortIfStmtSimpelConditionValue(
            cloneNode(this._shortIfStmt_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAShortIfStmtSimpelConditionValue(this);
    }
