...
public final class AShortIfStmtStringPartValue extends PStringPartValue
{
    private PShortIfStmt _shortIfStmt_;

    public AShortIfStmtStringPartValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShortIfStmtStringPartValue(
            cloneNode(this._shortIfStmt_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAShortIfStmtStringPartValue(this);
    }
