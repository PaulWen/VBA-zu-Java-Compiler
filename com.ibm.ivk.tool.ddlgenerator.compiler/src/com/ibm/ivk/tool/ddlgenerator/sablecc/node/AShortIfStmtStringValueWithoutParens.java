...
public final class AShortIfStmtStringValueWithoutParens extends PStringValueWithoutParens
{
    private PShortIfStmt _shortIfStmt_;

    public AShortIfStmtStringValueWithoutParens()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShortIfStmtStringValueWithoutParens(
            cloneNode(this._shortIfStmt_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAShortIfStmtStringValueWithoutParens(this);
    }
