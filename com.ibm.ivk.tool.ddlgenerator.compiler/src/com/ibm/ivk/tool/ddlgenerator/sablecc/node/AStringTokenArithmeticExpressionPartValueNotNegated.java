...
public final class AStringTokenArithmeticExpressionPartValueNotNegated extends PArithmeticExpressionPartValueNotNegated
{
    private TStringToken _stringToken_;

    public AStringTokenArithmeticExpressionPartValueNotNegated()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStringTokenArithmeticExpressionPartValueNotNegated(
            cloneNode(this._stringToken_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAStringTokenArithmeticExpressionPartValueNotNegated(this);
    }
