...
public final class ATrimFunctionComparisonValue extends PComparisonValue
{
    private PTrimFunction _trimFunction_;

    public ATrimFunctionComparisonValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATrimFunctionComparisonValue(
            cloneNode(this._trimFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseATrimFunctionComparisonValue(this);
    }
