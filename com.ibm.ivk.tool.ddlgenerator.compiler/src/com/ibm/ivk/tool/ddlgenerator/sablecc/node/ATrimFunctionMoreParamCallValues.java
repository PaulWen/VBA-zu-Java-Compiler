...
public final class ATrimFunctionMoreParamCallValues extends PMoreParamCallValues
{
    private PTrimFunction _trimFunction_;

    public ATrimFunctionMoreParamCallValues()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATrimFunctionMoreParamCallValues(
            cloneNode(this._trimFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseATrimFunctionMoreParamCallValues(this);
    }
