...
public final class ATrimFunctionParamCallListWithoutParensValue extends PParamCallListWithoutParensValue
{
    private PTrimFunction _trimFunction_;

    public ATrimFunctionParamCallListWithoutParensValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATrimFunctionParamCallListWithoutParensValue(
            cloneNode(this._trimFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseATrimFunctionParamCallListWithoutParensValue(this);
    }
