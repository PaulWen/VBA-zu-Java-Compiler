...
public final class ATrimFunctionStringPartValue extends PStringPartValue
{
    private PTrimFunction _trimFunction_;

    public ATrimFunctionStringPartValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATrimFunctionStringPartValue(
            cloneNode(this._trimFunction_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseATrimFunctionStringPartValue(this);
    }
