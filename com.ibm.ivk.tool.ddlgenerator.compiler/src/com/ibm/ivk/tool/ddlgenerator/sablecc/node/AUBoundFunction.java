...
public final class AUBoundFunction extends PUBoundFunction
{
    private TUBound _uBound_;
    private TOpenParen _openParen_;
    private PValue _value_;
    private TCloseParen _closeParen_;

    public AUBoundFunction()
    {
        // Constructor
    }

    public AUBoundFunction(
        @SuppressWarnings("hiding") TUBound _uBound_,
    ...
    public Object clone()
    {
        return new AUBoundFunction(
            cloneNode(this._uBound_),
    ...
    {
        ((Analysis) sw).caseAUBoundFunction(this);
    }

    public TUBound getUBound()
    {
        return this._uBound_;
    }

    public void setUBound(TUBound node)
    {
        if(this._uBound_ != null)
        {
            this._uBound_.parent(null);
        }
    ...
    {
        // Replace child
        if(this._uBound_ == oldChild)
        {
            setUBound((TUBound) newChild);
            return;
        }
