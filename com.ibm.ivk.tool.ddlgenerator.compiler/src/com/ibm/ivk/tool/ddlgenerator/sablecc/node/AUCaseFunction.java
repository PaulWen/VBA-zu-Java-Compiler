...
public final class AUCaseFunction extends PUCaseFunction
{
    private TUCase _uCase_;
    private TOpenParen _openParen_;
    private PValue _value_;
    private TCloseParen _closeParen_;

    public AUCaseFunction()
    {
        // Constructor
    }

    public AUCaseFunction(
        @SuppressWarnings("hiding") TUCase _uCase_,
    ...
    public Object clone()
    {
        return new AUCaseFunction(
            cloneNode(this._uCase_),
    ...
    {
        ((Analysis) sw).caseAUCaseFunction(this);
    }

    public TUCase getUCase()
    {
        return this._uCase_;
    }

    public void setUCase(TUCase node)
    {
        if(this._uCase_ != null)
        {
            this._uCase_.parent(null);
        }
    ...
    {
        // Replace child
        if(this._uCase_ == oldChild)
        {
            setUCase((TUCase) newChild);
            return;
        }
