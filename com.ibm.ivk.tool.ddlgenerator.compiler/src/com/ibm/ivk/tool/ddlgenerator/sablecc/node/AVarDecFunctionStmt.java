...
public final class AVarDecFunctionStmt extends PFunctionStmt
{
    private PVarDec _varDec_;
    private PGeneralStmt _generalStmt_;

    public AVarDecFunctionStmt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVarDecFunctionStmt(
    ...
    {
        ((Analysis) sw).caseAVarDecFunctionStmt(this);
    }
