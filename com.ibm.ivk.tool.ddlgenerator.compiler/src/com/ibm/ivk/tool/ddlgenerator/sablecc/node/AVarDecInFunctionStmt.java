...
public final class AVarDecInFunctionStmt extends PFunctionStmt
{
    private PVarDecIn _varDecIn_;
    private PGeneralStmt _generalStmt_;

    public AVarDecInFunctionStmt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVarDecInFunctionStmt(
    ...
    {
        ((Analysis) sw).caseAVarDecInFunctionStmt(this);
    }
