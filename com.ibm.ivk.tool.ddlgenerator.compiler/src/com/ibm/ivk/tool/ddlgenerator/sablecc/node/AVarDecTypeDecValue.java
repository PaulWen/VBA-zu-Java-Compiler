...
public final class AVarDecTypeDecValue extends PTypeDecValue
{
    private PVarDec _varDec_;
    private PGeneralStmt _generalStmt_;

    public AVarDecTypeDecValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVarDecTypeDecValue(
    ...
    {
        ((Analysis) sw).caseAVarDecTypeDecValue(this);
    }
