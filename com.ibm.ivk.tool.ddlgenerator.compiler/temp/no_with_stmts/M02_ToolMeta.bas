 ...
 Function getDataTypeByDomainIndex( _
   ...
   Optional useUnicode As Boolean = False _
     ...
     getDataTypeByDomainIndex = getDataType(g_domains.descriptors(domainIndex).dataType, g_domains.descriptors(domainIndex).maxLength, g_domains.descriptors(domainIndex).scale, useUnicode, g_domains.descriptors(domainIndex).unicodeExpansionFactor)
 End Function
