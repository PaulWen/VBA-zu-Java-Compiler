 ...
 Function allocDCompDescriptorIndex( _
   ...
   allocDCompDescriptorIndex = -1
     ...
     If dComps.numDescriptors = 0 Then
       ReDim dComps.descriptors(1 To gc_allocBlockSize)
     ElseIf dComps.numDescriptors >= UBound(dComps.descriptors) Then
       ReDim Preserve dComps.descriptors(1 To dComps.numDescriptors + gc_allocBlockSize)
     End If
     dComps.numDescriptors = dComps.numDescriptors + 1
     allocDCompDescriptorIndex = dComps.numDescriptors
 End Function
