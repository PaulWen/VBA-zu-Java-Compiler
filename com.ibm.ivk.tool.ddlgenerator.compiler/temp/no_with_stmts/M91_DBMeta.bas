 ...
 ' ### IF IVK ###
   ...
   For i = 1 To g_pools.numDescriptors
       If g_pools.descriptors(i).supportXmlExport Then
         poolIdsSupportingXmlExport = poolIdsSupportingXmlExport & IIf(poolIdsSupportingXmlExport = "", "", ",") & g_pools.descriptors(i).id
       End If
   Next i
